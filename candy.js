...
score = 0;
let highScores = []; // List of high scores

const timerEl = document.getElementById("timer");
const scoreEl = document.getElementById("score");
const leaderboardEl = document.getElementById("leaderboard-list");

// Update the timer and score tracker every second
...
document.getElementById('reset-button').addEventListener('click', () => {
    // Reset the time and score values
    timeLeft = 60;
    score = 0;
    
    // Reset the game elements and hide the game over screen
  ...
  function endGame() {
    ...
    // Display the high scores on the leaderboard
    leaderboardEl.innerHTML = "";
    for (let i = 0; i < highScores.length; i++) {
      const scoreItem = document.createElement("li");
      scoreItem.innerHTML = `Score: <span>${highScores[i]}</span>`;
